...
public class PracticeReadingReview extends AppCompatActivity {
    public static final String ID_TEST_RECORD_KEY = "id_test_record_key";
    private PracticeReading rawReview;
    List<ReadingReview> readingReviews;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_reading_review);
        ...
        addFragment(new int[]{1,2,3}, new ReadingReviewFragment(readingReviews.get(0), listBtnQuestion.get(0), listBtnQuestion.get(1),
    ...
    private void changeColorBtnQuestion(){
        int index = 0;
        for(ReadingReview readingReview: readingReviews){
    ...
    private void nextQuestion(){
        switch(currentQuestion){
            ...
            case 2:
            case 3:{
                addFragment(new int[]{4,5,6}, new ReadingReviewFragment(readingReviews.get(1), listBtnQuestion.get(3), listBtnQuestion.get(4),
            ...
            case 5:
            case 6:{
                addFragment(new int[]{7,8,9}, new ReadingReviewFragment(readingReviews.get(2), listBtnQuestion.get(6), listBtnQuestion.get(7),
